...
#define Q3MAP3_VERSION  "2.9.01" 
#define Q3MAP_MOTD		"Come Git Some"
...
#ifdef Q_UNIX
    #define PATH_MAX 4096    /* Buffer overflow error in libc.so.6. Let's try to fix that... */ 
...
Q_EXTERN qboolean           gpu Q_ASSIGN(qfalse); /* silicone_milk: using videocard? Use cpu by default.*/
#ifdef _DEBUG
Q_EXTERN qboolean			verbose Q_ASSIGN(qtrue); /*silicone_milk: give me verbose info if running debug build*/
#else 
